...
module.exports = {
    ...
    diagnose:(req,res)=>{
        ...
        if (params.length<4){
            const text = `
            <p class='lead text-nurse-blue text-justify'>You do not show sign of<strong> GONORRHEA INFECTION</strong>
        ...
        ` 
            ...
            const text = `
                <p class='lead text-nurse-blue text-justify'>You show signs of <strong> EARLY GONORRHEA</strong>
            ...
            const text = `
            <p class='lead text-nurse-blue text-justify'>You show signs of <strong> GONORRHEA INFECTION</strong>
            ensure you arrange a meeting with your DOCTOR for further clinical diagnosis
            You can also meet <strong>A QUALIFIED PHARMACIST</strong> with explanation of your <strong> SYMPTOMS. </strong> </p>
        ` 
            res.render('diagnosis/result', {text});
